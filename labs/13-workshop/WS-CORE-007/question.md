# WS-CORE-007 — SSH Public Key Provisioning
...
```bash
    python3 grader/runner.py --lab labs/09-ssh-access/WS-CORE-007 --submission configure_ssh_key.sh
```

## Workshop context
Day 2 · Practitioner · 14:05-14:40. Adapted from RHSA-SSH-001.
