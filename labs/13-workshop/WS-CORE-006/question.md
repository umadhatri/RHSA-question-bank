# WS-CORE-006 — Scoped Privileged Access
...
```bash
python3 grader/runner.py --lab labs/06-privileged-access/WS-CORE-006 --submission configure_sudo.sh
```


## Workshop context
Day 2 · Practitioner · 13:30-14:05. Adapted from RHSA-SUDO-001.
