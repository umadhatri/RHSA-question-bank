# WS-CORE-009 — Scheduled Maintenance
...
```bash
python3 grader/runner.py --lab labs/10-scheduled-jobs/WS-CORE-009 --submission configure_schedule.sh
```

## Workshop context
Day 2 · Practitioner · 15:25-15:55. Adapted from RHSA-SCHED-001.
