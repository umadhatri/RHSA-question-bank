...
Findings JSON fields: `affected_account`, `source_ip`, and `persistence` (an array of mechanism codes). Include `root_causes` for the environment fault then the data-access fault.
