# WS-CORE-004 — Process Management and Priority
...
```bash
python3 grader/runner.py --lab labs/07-process-management/WS-CORE-004 --submission manage_processes.sh
```

## Workshop context
Day 1 · Practitioner · 15:30-16:05. Adapted from RHSA-PROC-001.
